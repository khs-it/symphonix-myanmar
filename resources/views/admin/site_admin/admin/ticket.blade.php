                                ...
                                <table class="table" id="datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('edit_ticket/'.$ticket->id) }}"><button class="btn btn-sm btn-primary">Update</button></a>
                                                <a href="{{ url('delete_ticket/'.$ticket->id) }}"><button class="btn btn-sm btn-danger">Delete</button></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ url('create_ticket') }}" method="post" class="md-form">
                            @csrf
